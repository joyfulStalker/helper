...
public class SwaggerResourcesExtProvider {
    ...
    public SwaggerResourcesExtProvider(Environment environment, DocumentationCache documentationCache) {
        ...
        swagger1Available = ClassSupport.classByName("springfox.documentation.swagger1.web.Swagger1Controller").isPresent();
        swagger2Available = ClassSupport.classByName("springfox.documentation.swagger2.web.Swagger2Controller").isPresent();
